...
function createSampleGameData() {
  const games = [
    ...
    },
    {
      ...
      platforms: ["PlayStation", "Xbox"],
      description:
        "The latest installment in the college football simulation series.",
      developer: "EA Sports",
      publisher: "EA Sports",
      genre: "Sports",
    },
    {
      ...
      description:
        "A cozy hobbit life simulation game set in the Lord of the Rings universe.",
    ...
    },
    {
      ...
      description:
        "The next installment in the Borderlands looter-shooter series.",
    ...
    },
    {
      ...
      platforms: ["PlayStation", "Xbox"],
      description:
        "A tactical first-person shooter inspired by modern day swat operations.",
...
async function scrapeGames() {
  try {
    ...
    console.log(
      `Successfully created ${gameData.games.length} games and saved to ${filePath}`
    );
  } catch (error) {
